...
data = pd.read_csv('Dataset.csv', parse_dates=['Attribute'], index_col=['Attribute'])

# Drop unnecessary columns
columns_to_drop = ['Unnamed: 0', 'Year', 'Month', 'Day', 'datetime']
...
fig = go.Figure()
fig.add_trace(go.Scatter(x=data_subset["Attribute"], y=data_subset["Value"], mode="markers", name="Data"))
fig.add_trace(go.Scatter(x=data_subset["Attribute"], y=data_subset["Value"], mode="lines", name="Line"))
